...
url: /termos-uso/
---
**Termos e condições gerais de uso do aplicativo Jurisprudência GPT**

Os serviços do **Jurisprudência GPT** são fornecidos pela pessoa jurídica com a seguinte Razão Social/nome: STUDIO 365 SOLUCOES PARA TRANSFORMACAO DIGITAL LTDA, inscrito no CNPJ sob o nº 38.145.260/0001-28, titular da propriedade intelectual sobre software, website, aplicativos, conteúdos e demais ativos relacionados à plataforma Jurisprudência GPT.
...
A plataforma caracteriza-se pela prestação do seguinte serviço: Atendimento Virtual para usuários.
A plataforma realiza a venda à distância por meio eletrônico dos seguintes produtos ou serviços: Plataforma de Atendimento Virtual multicanal para empresas e organizações.

#### 2. Da aceitação
O presente Termo estabelece obrigações contratadas de livre e espontânea vontade, por tempo indeterminado, entre a plataforma e as pessoas físicas ou jurídicas, usuárias do aplicativo e site Jurisprudência GPT.
...
#### 4. Do cadastro
O acesso às funcionalidades da plataforma poderá, aplicável a perfis específicos de uso, considerar a realização de um cadastro de identificação prévio e, a depender dos serviços e papel desempenhado ou por sua corporação delegados, registrar dados para medições de cobrança a corporação solicitante.
...
O usuário poderá, a qualquer tempo, requerer o cancelamento de seu cadastro junto ao site e/ou aplicativo Jurisprudência GPT. O seu descadastramento será realizado o mais rapidamente possível, desde que não sejam verificados débitos em aberto.
O usuário, ao aceitar os Termos e Política de Privacidade, autoriza expressamente a plataforma a coletar, usar, armazenar, tratar ou utilizar as informações derivadas do uso dos serviços, do site e quaisquer plataformas, incluindo todas as informações preenchidas pelo usuário no momento em que realizar ou atualizar seu cadastro, além de outras expressamente descritas na Política de Privacidade que deverá ser autorizada pelo usuário.
...
Os preços são indicados em reais e não incluem as taxas/impostos, as quais são especificadas à parte e são informadas ao usuário antes da finalização da contratação.

Na contratação de determinado serviço ou produto, a plataforma poderá solicitar as informações financeiras do usuário e/ou empresa contratante, como CPF/CNPJ, endereço de cobrança e dados complementares de pagamento. Ao inserir referidos dados o usuário concorda que sejam cobrados, de acordo com a forma de pagamento que venha a ser escolhida, os preços então vigentes e informados quando da contratação. 

A contratação dos serviços será renovada automaticamente pela plataforma, independentemente de comunicação ao usuário e/ou empresa contratante, mediante cobrança periódica da mesma forma de pagamento indicada pelo usuário quando da contratação do serviço.

#### 7. Do cancelamento
O usuário poderá cancelar a contratação dos serviços de acordo com os termos que forem definidos no momento de sua contratação. Ainda, o usuário também poderá cancelar os serviços em até 7 (sete) dias após a contratação, mediante contato com o [contato@studio365.io](https://mailto:contato@studio365.io), de acordo com o Código de Defesa do Consumidor (Lei no. 8.078/90).
...
#### 8. Do suporte
Em caso de qualquer dúvida, sugestão ou problema com a utilização da plataforma, o usuário poderá entrar em contato com o suporte, através do email [suporte@studio365.io](https://mailto:suporte@studio365.io) ou recursos de atendimento/apoio disponíveis no aplicativo Jurisprudência GPT.
Estes serviços de atendimento ao usuário estarão disponíveis nos seguintes dias e horários: segunda à sexta-feira, das 09:00h às 18:00h.
...
É de responsabilidade da plataforma Jurisprudência GPT:
...
O presente Termo de Uso concede aos usuários e/ou empresa contratante uma licença não exclusiva, não transferível e não sublicenciável, para acessar e fazer uso da plataforma e dos serviços e produtos por ela disponibilizados.
A estrutura do site ou aplicativo, as marcas, logotipos, nomes comerciais, layouts, gráficos e design de interface, imagens, ilustrações, fotografias, apresentações, vídeos, conteúdos escritos e de som e áudio, programas de computador, banco de dados, arquivos de transmissão e quaisquer outras informações e direitos de propriedade intelectual da razão social STUDIO 365 SOLUCOES PARA TRANSFORMACAO DIGITAL LTDA, observados os termos da Lei da Propriedade Industrial (Lei nº 9.279/96), Lei de Direitos Autorais (Lei nº 9.610/98) e Lei do Software (Lei nº 9.609/98), estão devidamente reservados.
...
O uso da plataforma pelo usuário é pessoal, individual e intransferível, sendo vedado qualquer uso não autorizado, comercial ou não-comercial. Tais usos consistirão em violação dos direitos de propriedade intelectual da razão social STUDIO 365 SOLUCOES PARA TRANSFORMACAO DIGITAL LTDA, puníveis nos termos da legislação aplicável.

#### 11. Das sanções
Sem prejuízo das demais medidas legais cabíveis, a razão social STUDIO 365 SOLUCOES PARA TRANSFORMACAO DIGITAL LTDA poderá, a qualquer momento, advertir, suspender ou cancelar a conta do usuário:
...
#### 12. Da rescisão
A não observância das obrigações pactuadas neste Termo de Uso ou da legislação aplicável poderá, sem prévio aviso, ensejar a imediata rescisão unilateral por parte da razão social STUDIO 365 SOLUCOES PARA TRANSFORMACAO DIGITAL LTDA e o bloqueio de todos os serviços prestados ao usuário.

#### 13. Das alterações
Os itens descritos no presente instrumento poderão sofrer alterações, unilateralmente e a qualquer tempo, por parte de STUDIO 365 SOLUCOES PARA TRANSFORMACAO DIGITAL LTDA, para adequar ou modificar os serviços, bem como para atender novas exigências legais. As alterações serão veiculadas pelo site e pelo aplicativo Jurisprudência GPT e o usuário poderá optar por aceitar o novo conteúdo ou por cancelar o uso dos serviços, caso seja assinante de algum serviço.
...
Além do presente Termo, o usuário deverá consentir com as disposições contidas na respectiva [Política de Privacidade](https://docs.studio365.io/docs/balcao-virtual-privacidade) a ser apresentada a todos os interessados dentro da interface da plataforma.
